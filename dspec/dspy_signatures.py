...
try:
    ...
    class EngineeringConcept(BaseModel):
        ...
        mental_model: str = Field(max_length=260)
    ...
    class DiscoveryOption(BaseModel):
        ...
        plain_english_consequence: str | None = Field(default=None, max_length=180)
        ...
        technical_details: list[TechnicalDetail] = Field(default_factory=list, max_length=4)
    ...
    class ArchitectureOption(BaseModel):
        ...
        role: str = Field(description="best_fit, simplest, or alternative", max_length=24)
        title: str = Field(max_length=120)
        plain_english_summary: str = Field(max_length=500)
        why_recommended: str = Field(max_length=500)
        ...
        technical_details: list[TechnicalDetail] = Field(max_length=10)
